...
# MODEL
# =========================================================
def build_basic_encoder_decoder(input_shape=(256, 256, 3)):
...
def save_model_config():
    config = {
        ...
        "architecture": {
            "encoder_block_1": ["Conv2D(16,3x3)+ReLU", "Conv2D(16,3x3)+ReLU", "MaxPool"],
            "encoder_block_2": ["Conv2D(32,3x3)+ReLU", "Conv2D(32,3x3)+ReLU", "MaxPool"],
            "bottleneck": ["Conv2D(64,3x3)+ReLU", "Conv2D(64,3x3)+ReLU"],
            "decoder_block_1": ["UpSampling", "Conv2D(32,3x3)+ReLU"],
            "decoder_block_2": ["UpSampling", "Conv2D(16,3x3)+ReLU"],
...
def train_and_evaluate_fold(fold_num: int):
    ...
    model = build_basic_encoder_decoder(input_shape=(IMAGE_SIZE[0], IMAGE_SIZE[1], 3))
    model.compile(
